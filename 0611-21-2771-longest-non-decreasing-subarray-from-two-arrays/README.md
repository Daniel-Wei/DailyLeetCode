<h2> 611 21
2771. Longest Non-decreasing Subarray From Two Arrays</h2><hr><div><p>You are given two <strong>0-indexed</strong> integer arrays <code>nums1</code> and <code>nums2</code> of length <code>n</code>.</p>
